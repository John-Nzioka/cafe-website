...
$query = "SELECT * FROM cakeproducts ORDER BY id DESC ";
...
?>
        ...
        <tr>
            ...
            <td><?=$price; ?></td>
            <td>
               <img src= "<?= "uploads/".$image?>" alt="<?= $title ?>" class="thumbnail" width="150px" height="75px">
            </td>
...
<?php
    ...
    if(isset($_GET['delete'])){
        ...
        $image = "SELECT * FROM cakeproducts WHERE id = $id";
        ...
        $querydelete = "DELETE FROM cakeproducts WHERE id = $id";

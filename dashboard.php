        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="form-group">
                  <label for="title"> CakeTitle</label>
                  <input type="text" class="form-control" name="caketitle"  placeholder="Enter Title" value="">
                </div>
                <div class="form-group">
                  <label for="description">Cake Description:</label>
                  <input type="text" class="form-control" name="cakedescription" placeholder="Enter Description" value="">
                </div>
                <div class="form-group">
                  <label for="price">Cake Price</label>
                  <input type="text" class="form-control" name="cakeprice" placeholder="Enter Price" value="">
                </div>
                <div class="form-group">
